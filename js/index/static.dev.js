/** 主题图标路径 */
var iconfield = "static/img/theme/";
/** 主题路径 */
var doownfield = 'static/themes/';
/** 主题展示图路径 */
var toimgs = 'static/img/themeto/';
/** 作者图标路径 */
var aouticon = 'static/img/aout/';
/** 主题信息
...
var themes = [{
    ...
    Version: "EMUI5.1及以下",
    file: '2.hwt',
    toimgs: ['2-1.png', '2-2.png', '2-3.png', '2-4.png', '2-5.png', '2-6.png']
}, {
    aouts: 'Masuku',
    icon: "3.png",
    link: "https://www.coolapk.com/apk/com.me.masuku",
    name: "Me（尝鲜版）",
    Version: "EMUI8.0及以下",
    file: '3.hwt',
    toimgs: ['3-1.png', '3-2.png', '3-3.png', '3-4.png', '3-5.png', '3-6.png']
}];
/** 作者信息 */
var themesaoutes = {
    /** 作者数据存放区 */
...
/** 源节点 */
var Themessoure = $('.ThemeSource').clone(true);
/** 主题展示区父节点 */
var ThemesRoot = $('.ThemeSource').parent();